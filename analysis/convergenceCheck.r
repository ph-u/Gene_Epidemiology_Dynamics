...
##### env #####
source("colour.r")
f.in0 = list.files("../data/20260908", pattern = "thres", full.names = T)
f.in1 = list.files("../data/20260908", pattern = "all_", full.names = T)
f.in2 = list.files("../data/20260908", pattern = "last_", full.names = T)
